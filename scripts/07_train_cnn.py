...
=======================
Train Model A: Conventional CNN Baseline.
...
from src.models import CNNBaseline, MaskedMSELoss
...
def main():
    print("=" * 70)
    print("STAGE 4 — TRAINING MODEL A: CNN BASELINE")
    print("=" * 70)
    ...
    checkpoint_path = models_dir / "cnn_baseline_best.pt"
    history_path = metrics_dir / "cnn_baseline_history.json"
    ...
    model = CNNBaseline(in_channels=7, num_depths=15).to(device)
    ...
    print(f"\nCNN Baseline Training Complete! Total time: {total_training_time:.2f}s | Best Val Loss: {best_val_loss:.6f}")
